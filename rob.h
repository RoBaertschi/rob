 ...
 * ROB Build System.
 * Build requirements:
 *  Include "rob.h" in your c file, the file is named "rob.c" by convention. The file tries to resolve the right c source file using __FILE__, 
 *  but if that does not work, you will probably have to set ROB_C_FILE. Also rob uses ROB_BIN_FILE which is by default "./rob" to check if it needs to be rebuild.
 */
#ifndef ROB_H_
#define ROB_H_
